...
namespace ContactCenterDA.Repositories.CC.TH
{
    public class TarifaRepository : ITarifaRepository
    {
        ...
        public bool Update(Tarifa datos)
        {
            ...
            OleDbParameter idObra = UtilDA.SetParameters("@idObra", OleDbType.Integer, datos.Obra.IdObra);
            OleDbParameter precio = UtilDA.SetParameters("@precio", OleDbType.Single, datos.Precio);
            OleDbParameter fechaCrea = UtilDA.SetParameters("@fechaMod", OleDbType.Date, DateTime.Now);
            OleDbParameter userCrea = UtilDA.SetParameters("@userMod", OleDbType.VarChar, Sesion.usuario.Login);
            OleDbParameter idTarifa = UtilDA.SetParameters("@idTarifa", OleDbType.Integer, datos.IdTarifa);
